...
import org.apache.beam.sdk.values.TupleTag;
    ...
    public class Inner_Join{
        ...
        public static void main(String[] args) {
            ...
            PCollection<KV<String,String>> pOrderCollection = p.apply(TextIO.read().from("C:\\Users\\asus\\OneDrive\\Desktop\\Results\\Inner_join\\user_order.csv"))
                    .apply(ParDo.of(new OrderParsing()));

            PCollection<KV<String,String>> pUserCollection = p.apply(TextIO.read().from("C:\\Users\\asus\\OneDrive\\Desktop\\Results\\Inner_join\\p_user.csv"))
            ...
            output.apply(TextIO.write().to("C:\\Users\\asus\\OneDrive\\Desktop\\Results\\Inner_join\\cogroup_by_key.csv").withNumShards(1).withSuffix(".csv"));
            p.run();
